...
export const Sidebar: React.FC<SidebarProps> = ({ className = '', type }) => {
  ...
  return (
    <aside
      className={`w-60 shrink-0 bg-[#0a0a0c] border-r border-zinc-800 p-4 min-h-[calc(100vh-4rem)] hidden md:block ${className}`}
    >
      <div className="mb-6 px-3 py-2 bg-zinc-900/60 rounded border border-zinc-800">
          ...
          return (
            <NavLink
              ...
              className={`flex items-center gap-3 px-3 py-2 text-xs rounded transition-colors ${
                isActive
                  ? 'border-l-2 border-white bg-zinc-900 text-white font-semibold'
